...
MODEL_CHECKPOINT = "fcakyon/timesformer-large-finetuned-k400"
NUM_EMOTION_CLASSES = 10  # Number of classes in your dataset

# --- File Paths & Directories ---
# IMPORTANT: Update these paths to your actual locations
DATASET_ROOT_DIRECTORY = "/home/hr/Roodaki/VFER/rotated_face_trimmed_organized"
SAVE_DIR = "/home/hr/Roodaki/VFER/Emognition Codebase/models/timesformer/checkpoints/timesformer-large-finetuned-k400"
BEST_MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_timesformer.pth")
LAST_CHECKPOINT_PATH = os.path.join(SAVE_DIR, "last_timesformer.pth")
...
def main():
    ...
    print("Froze `model.timesformer` backbone.")
